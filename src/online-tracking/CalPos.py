...
def CalPos(dt_con=None,xr=None,yr=None,x_now=None,y_now=None,a_now=None,idx=None):
    #------- cost ------#
    ...
    sign_x = sign(x_ol[1]-x_ol[0])
    sign_y = sign(y_ol[1]-y_ol[0])
    angle_next = atan((y_ol[1]-y_ol[0])/(x_ol[1]-x_ol[0]))
    if sign_x >= 0:
        if sign_y >= 0: # 1 area
            pass
    ...
    return x_ol[1],y_ol[1],angle_next
